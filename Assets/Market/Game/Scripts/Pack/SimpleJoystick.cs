...
namespace MarketShopandRetailSystem
{
    ...
    public class SimpleJoystick : MonoBehaviour, IDragHandler, IPointerUpHandler, IPointerDownHandler
    {
        ...
        public virtual void OnDrag(PointerEventData eventData)
        {
            ...
            Direction.x = HorizontalValue;
            Direction.y = VerticalValue;
            this.PostEvent(EventID.PlayerEvent.PlayMove, Direction);
        }
        ...
        public void OnPointerUp(PointerEventData eventData)
        {
            ...
            this.PostEvent(EventID.PlayerEvent.PlayMove, Vector2.zero);
            if (HideOnRelease)
            {
                Hide(true);
            }
